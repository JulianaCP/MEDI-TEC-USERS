...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_enfermedades) {
            ...
            Global.accionActual= "sintoma";
            SintomasFragment nuevoFragment = new SintomasFragment();
            FragmentManager manager = getSupportFragmentManager();
            manager.beginTransaction().replace(R.id.ContentForFragments, nuevoFragment).commit();

        } else if (id == R.id.nav_medicamentos) {
            Global.accionActual= "medicamento";
            MedicamentosFragment nuevoFragment = new MedicamentosFragment();
            FragmentManager manager = getSupportFragmentManager();
            manager.beginTransaction().replace(R.id.ContentForFragments, nuevoFragment).commit();
        }
